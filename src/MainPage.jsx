...
function MainPage() {
  ...
  const toggleModal = () => setOpenModalWindow(!openModalWindow);
  const workModal = () => setOpenWorkModal(!openWorkModal);
  const portfolioPage = () => setOpenPortfolio(!openPortfolio);
        ...
        <header>
          ...
          <section className="portfolio">
            <div className='portfolio-btn-container'>
              <button className="portfolio-btn" onClick={portfolioPage}>PORTFOLIO</button>
            </div>
          </section>
          ...
          {openWorkModal && (
            <div className="work-modal-overlay" onClick={workModal}>
              <div className="work-modal-content" onClick={(e) => e.stopPropagation()}>
                ...
                <h2 className='github-text'>This is my GitHub</h2>
                <a
          ...
          {/* Portfolio Modal */}
          {openPortfolio && (
            <div className="portfolio-overlay" onClick={portfolioPage}>
              <div className="portfolio-content" onClick={(e) => e.stopPropagation()}>
                <span className="close-button" onClick={portfolioPage}>X</span>
                {/* Тут можешь вставить проекты */}
              </div>
            </div>
          )}
        </header>
